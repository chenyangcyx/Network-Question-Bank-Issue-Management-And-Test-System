	...
	<div class="row clearfix">
		...
		<div class="col-md-10 column">
			<div class="alert alert-dismissable alert-info">
                 ...
                 <?php
						$result=mysqli_query($con,"select teacher_info.*,teacher_account.* from teacher_info,teacher_account where teacher_info.teacher_username=teacher_account.teacher_username and teacher_info.teacher_username='${_SESSION["username"]}'");
                        ...
                        $password=$bookinfo["teacher_password"];
					?>
				<h4>
