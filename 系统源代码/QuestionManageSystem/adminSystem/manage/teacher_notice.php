...
<div class="container">
	...
	<div class="row clearfix">
		...
		<div class="col-md-3 column">
			 ...
			 <button type="button" class="btn btn-default btn-block btn-warning" onclick="window.location.href='teacher_notice.php'">教师公告</button>
		...
		<div class="col-md-7 column">
			<p>
				...
				?>
				<form action="notice_teacher_change.php" method="post" role="form">
					<p>
						<?php
						if($bookinfo){
					...
					if($bookinfo){
						...
						echo '<button type="button" class="btn btn-default btn-block btn-danger" onclick="window.location.href=\'notice_teacher_delete.php?admin_username='.$_SESSION["username"].'\''.'">删除通知</button>';
					}else{
